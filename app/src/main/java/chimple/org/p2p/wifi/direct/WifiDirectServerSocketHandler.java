...
public class WifiDirectServerSocketHandler extends Thread {

    private ServerSocket serverSocket = null;
    private final int THREAD_COUNT = 10;
    private Handler handler;
    private static final String TAG = WifiDirectHandler.TAG + "WifiDirectServerSocketHandler";

    public WifiDirectServerSocketHandler(Handler handler) throws IOException {
        try {
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                pool.execute(new SocketManager(serverSocket.accept(), handler));
